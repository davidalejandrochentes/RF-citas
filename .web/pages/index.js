...
export function Main_e527e970a77b0343bb950363894dd34c () {
...
"Agendar Nueva Cita"
,),jsx(Form_0bea7691a63f1dd03adb3bf9f8725061,{},)
,),jsx(
"div",
...
export function Fragment_c352f7688499fc7dfb4eb316b34642a7 () {
...
"Servicio"
,),jsx(Select_f1e68d210adfff234c82ac1276a62899,{},)
,),jsx(
"button",
...
export function Select_f1e68d210adfff234c82ac1276a62899 () {
...
reflex___state____state__app___states___state____barber_state.services.map((service,index_aa49fa07dc4c31fc)=>(jsx(
"option",
{key:index_aa49fa07dc4c31fc,value:service["name"]},
...
export function Div_80833b8f92f2b00c3bc078347bbf7581 () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_d7ea1fe21077ae60)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_d7ea1fe21077ae60},
day
,))),)
  )
}
...
export function Div_5a4bfde63e865090b5bdf5bd7b613ef6 () {
...
reflex___state____state__app___states___state____barber_state.available_times_for_selected_date_and_barber.map((time,index_db91946b34e21e30)=>(jsx(
"button",
{className:((reflex___state____state__app___states___state____barber_state.selected_time === time) ? "w-full py-2 px-4 rounded-lg bg-blue-600 text-white font-semibold shadow-md" : "w-full py-2 px-4 rounded-lg bg-gray-100 hover:bg-blue-100 text-gray-800 font-medium transition-colors"),key:index_db91946b34e21e30,onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.select_time", ({ ["time_str"] : time }), ({  })))], args, ({  })))),type:"button"},
jsx(
Moment,
{format:"hh:mm A",parse:"HH:mm"},
time
...
export function Form_0bea7691a63f1dd03adb3bf9f8725061 () {
...
,),jsx(Div_80833b8f92f2b00c3bc078347bbf7581,{},)
,jsx(Div_d17c162098e4169258f30ab240b88621,{},)
,),jsx(Fragment_bf4c9b6292e301b59b7fb28b8b545d11,{},)
,jsx(Fragment_32ab48b04f9f92d09c44afea30c883d6,{},)
,),jsx(Fragment_c352f7688499fc7dfb4eb316b34642a7,{},)
,),)
  )
}
...
export function Fragment_32ab48b04f9f92d09c44afea30c883d6 () {
...
,jsx(Fragment_c22ddb64b44c2466518a8711f8d1a8fc,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}
...
export function Fragment_bf4c9b6292e301b59b7fb28b8b545d11 () {
...
,jsx(Select_e24e248ef2ef6bb0b4a482784c1ec601,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}

export function Div_d17c162098e4169258f30ab240b88621 () {
...
reflex___state____state__app___states___state____barber_state.calendar_weeks.map((week,index_5f5ac021d4d517c9)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_5f5ac021d4d517c9},
week.map((day_data,index_21238847b285a912)=>(jsx(
Fragment,
{key:index_21238847b285a912},
...
export function Select_e24e248ef2ef6bb0b4a482784c1ec601 () {
...
,),reflex___state____state__app___states___state____barber_state.barber_names.map((barber,index_a3fbd3e6a9706397)=>(jsx(
"option",
{key:index_a3fbd3e6a9706397,value:barber},
barber
,))),)
  )
}

export function Fragment_c22ddb64b44c2466518a8711f8d1a8fc () {
...
Fragment,
{},
jsx(Div_5a4bfde63e865090b5bdf5bd7b613ef6,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
Fragment,
{},
jsx(Main_e527e970a77b0343bb950363894dd34c,{},)
,jsx(
NextHead,
{},
jsx(
