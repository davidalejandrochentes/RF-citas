...
export function Div_02afbb4445c777e6bfd139a99d77eff1 () {
...
reflex___state____state__app___states___state____barber_state.calendar_weeks.map((week,index_08a842c75621b69e)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_08a842c75621b69e},
week.map((day_data,index_5fd8827706fd765c)=>(jsx(
Fragment,
{key:index_5fd8827706fd765c},
...
export function Div_455347501de2a1440a6bcc6f36a05b54 () {
...
reflex___state____state__app___states___state____barber_state.available_times_for_selected_date_and_barber.map((time,index_d64b83aac57e936c)=>(jsx(
"button",
{className:((reflex___state____state__app___states___state____barber_state.selected_time === time) ? "w-full py-2 px-4 rounded-lg bg-blue-600 text-white font-semibold shadow-md" : "w-full py-2 px-4 rounded-lg bg-gray-100 hover:bg-blue-100 text-gray-800 font-medium transition-colors"),key:index_d64b83aac57e936c,onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.select_time", ({ ["time_str"] : time }), ({  })))], args, ({  })))),type:"button"},
jsx(
Moment,
...
export function Fragment_eeb3c13ad7c922e27dd85bb4e34ba0ec () {
...
"Servicio"
,),jsx(Select_b04aa9cb94579ae99395234e51925d67,{},)
,),jsx(
"button",
...
export function Main_eafbaec6fad852bfe3c227d6abfcb036 () {
  
  
                useEffect(() => {
                    ((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.load_appointments", ({  }), ({  })))], args, ({  }))))()
                    return () => {
...
"Agendar Nueva Cita"
,),jsx(Form_b85798b723dbf0d2634d54b9d99fd80f,{},)
,),jsx(
"div",
...
export function Form_b85798b723dbf0d2634d54b9d99fd80f () {
...
,),jsx(Div_8434c7357250223e735976c0f36c08fd,{},)
,jsx(Div_02afbb4445c777e6bfd139a99d77eff1,{},)
,),jsx(Fragment_bb884da5e384b8da5075cec28cf095a8,{},)
,jsx(Fragment_a4e96abd7390dcc935f6f60dd2e6ac06,{},)
,),jsx(Fragment_eeb3c13ad7c922e27dd85bb4e34ba0ec,{},)
,),)
  )
}
...
export function Fragment_bb884da5e384b8da5075cec28cf095a8 () {
...
Fragment,
{},
(!((reflex___state____state__app___states___state____barber_state.selected_date === "")) ? (jsx(
Fragment,
{},
jsx(
"div",
...
,jsx(Select_3fea7d6621abcdd3ac7f44f37dd971ce,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}
...
export function Select_3fea7d6621abcdd3ac7f44f37dd971ce () {
...
,),reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_a3346e87f36953c6)=>(jsx(
"option",
{key:index_a3346e87f36953c6,value:barber},
barber
,))),)
  )
}
...
export function Fragment_a4e96abd7390dcc935f6f60dd2e6ac06 () {
...
,jsx(Fragment_d4173ff4db006bed22fda604ad86756d,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}

export function Fragment_d4173ff4db006bed22fda604ad86756d () {
...
Fragment,
{},
jsx(Div_455347501de2a1440a6bcc6f36a05b54,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
export function Select_b04aa9cb94579ae99395234e51925d67 () {
...
Object.entries(reflex___state____state__app___states___state____barber_state.services).map((service_item,index_a4c5207012331bf0)=>(jsx(
"option",
{key:index_a4c5207012331bf0,value:service_item.at(0)},
(service_item.at(0)+" - $"+service_item.at(1))
,))),)
  )
}
...
export function Div_8434c7357250223e735976c0f36c08fd () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_f74eb170fd9744a8)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_f74eb170fd9744a8},
day
,))),)
  )
}
...
Fragment,
{},
jsx(Main_eafbaec6fad852bfe3c227d6abfcb036,{},)
,jsx(
NextHead,
{},
jsx(
