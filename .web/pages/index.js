...
export function Main_7258fba59a294e6bbad99369cdf59a4a () {
...
"Agendar Nueva Cita"
,),jsx(Form_a9d0406d5c7e81786ccd32f535a44860,{},)
,),jsx(
"div",
...
export function Fragment_d8006d9c747a444e81ad832b6599b782 () {
...
,jsx(Select_d8766bbde1076f68251e0323045b4374,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}

export function Select_d8766bbde1076f68251e0323045b4374 () {
...
,),reflex___state____state__app___states___state____barber_state.barber_names.map((barber,index_db752da54d3ce531)=>(jsx(
"option",
{key:index_db752da54d3ce531,value:barber},
barber
,))),)
  )
}
...
export function Div_3ee302629b28efc64324fd1831cd700e () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_bda691b685791806)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_bda691b685791806},
day
,))),)
  )
}

export function Fragment_60a72529197ab9d5a84ef7fda5d31098 () {
...
Fragment,
{},
jsx(Div_9867c035874eb34d070fa12f40314acc,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
export function Div_9709160edc31e0fda5bef511698a19d5 () {
...
reflex___state____state__app___states___state____barber_state.calendar_weeks.map((week,index_87a10a23f5ff8dfe)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_87a10a23f5ff8dfe},
week.map((day_data,index_e2fceb63d609d178)=>(jsx(
Fragment,
{key:index_e2fceb63d609d178},
...
export function Fragment_3aca7f41bf627eb506cead19fea694b4 () {
...
,jsx(Fragment_60a72529197ab9d5a84ef7fda5d31098,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}
...
export function Select_98b3e9bb784b7c7193a1a2f77f6e0ddf () {
...
reflex___state____state__app___states___state____barber_state.services.map((service,index_30c1bb09ba6d226a)=>(jsx(
"option",
{key:index_30c1bb09ba6d226a,value:service["name"]},
...
export function Fragment_da1a3c2c346e506afd37cb35b90de0d9 () {
...
"Servicio"
,),jsx(Select_98b3e9bb784b7c7193a1a2f77f6e0ddf,{},)
,),jsx(
"button",
...
export function Form_a9d0406d5c7e81786ccd32f535a44860 () {
  
  const [addEvents, connectErrors] = useContext(EventLoopContext);

  
    const handleSubmit_dfb150d9313c8e54729e1cd5b230af9b = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["name"] : getRefValue(refs["ref_name"]), ["service"] : getRefValue(refs["ref_service"]), ["phone"] : getRefValue(refs["ref_phone"]) })};
  ...
  return (
    jsx(
"form",
{className:"w-full",onSubmit:handleSubmit_dfb150d9313c8e54729e1cd5b230af9b},
jsx(
"div",
...
,),jsx(Div_3ee302629b28efc64324fd1831cd700e,{},)
,jsx(Div_9709160edc31e0fda5bef511698a19d5,{},)
,),jsx(Fragment_d8006d9c747a444e81ad832b6599b782,{},)
,jsx(Fragment_3aca7f41bf627eb506cead19fea694b4,{},)
,),jsx(Fragment_da1a3c2c346e506afd37cb35b90de0d9,{},)
,),)
  )
}
...
export function Div_9867c035874eb34d070fa12f40314acc () {
...
reflex___state____state__app___states___state____barber_state.available_times_for_selected_date_and_barber.map((time,index_777ee7ddfb470844)=>(jsx(
"button",
{className:((reflex___state____state__app___states___state____barber_state.selected_time === time) ? "w-full py-2 px-4 rounded-lg bg-blue-600 text-white font-semibold shadow-md" : "w-full py-2 px-4 rounded-lg bg-gray-100 hover:bg-blue-100 text-gray-800 font-medium transition-colors"),key:index_777ee7ddfb470844,onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.select_time", ({ ["time_str"] : time }), ({  })))], args, ({  })))),type:"button"},
jsx(
Moment,
{format:"hh:mm A",parse:"HH:mm"},
time
...
Fragment,
{},
jsx(Main_7258fba59a294e6bbad99369cdf59a4a,{},)
,jsx(
NextHead,
{},
jsx(
