...
export function Select_bbd507b64bbbb5e686bcae2315df6b5c () {
...
reflex___state____state__app___states___state____barber_state.services.map((service,index_d9c9ea1d0d2ac4b6)=>(jsx(
"option",
{key:index_d9c9ea1d0d2ac4b6,value:service["name"]},
(service["name"]+" - $"+service["price"])
,))),)
  )
}

export function Fragment_d58c668202841bc436ef837dd6f3c219 () {
...
,jsx(Select_bc051fc0ecdcaa64758f54c2837ff387,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}
...
export function Fragment_0c9e09a234db6e3ca3197d4af175980d () {
...
Fragment,
{},
jsx(Div_5fa30f54af8622f6961f0e5ec704b0d5,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
export function Div_ab05b42780aca31f56f8bb71987ac25e () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_c36529d0a1792e31)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_c36529d0a1792e31},
day
,))),)
  )
}

export function Div_5fa30f54af8622f6961f0e5ec704b0d5 () {
...
reflex___state____state__app___states___state____barber_state.available_times_for_selected_date_and_barber.map((time,index_4d25a0bd4f060921)=>(jsx(
"button",
{className:((reflex___state____state__app___states___state____barber_state.selected_time === time) ? "w-full py-2 px-4 rounded-lg bg-blue-600 text-white font-semibold shadow-md" : "w-full py-2 px-4 rounded-lg bg-gray-100 hover:bg-blue-100 text-gray-800 font-medium transition-colors"),key:index_4d25a0bd4f060921,onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.select_time", ({ ["time_str"] : time }), ({  })))], args, ({  })))),type:"button"},
jsx(
Moment,
{format:"hh:mm A",parse:"HH:mm"},
time
...
export function Fragment_f3c21566f73ec5ee3c362f3ce1cf48ab () {
...
"Servicio"
,),jsx(Select_bbd507b64bbbb5e686bcae2315df6b5c,{},)
,),jsx(
"button",
...
export function Form_6f0bc1ba8e311ea01189713474c93c04 () {
...
,),jsx(Div_ab05b42780aca31f56f8bb71987ac25e,{},)
,jsx(Div_4ec302cf44cf76594513a0c5b90c845c,{},)
,),jsx(Fragment_d58c668202841bc436ef837dd6f3c219,{},)
,jsx(Fragment_cfcbadab9e514cfd4bdd52eb2fac788b,{},)
,),jsx(Fragment_f3c21566f73ec5ee3c362f3ce1cf48ab,{},)
,),)
  )
}
...
export function Select_bc051fc0ecdcaa64758f54c2837ff387 () {
...
,),reflex___state____state__app___states___state____barber_state.barber_names.map((barber,index_4b5faf390bc76a7e)=>(jsx(
"option",
{key:index_4b5faf390bc76a7e,value:barber},
barber
,))),)
  )
}
...
export function Div_4ec302cf44cf76594513a0c5b90c845c () {
...
reflex___state____state__app___states___state____barber_state.calendar_weeks.map((week,index_4787408ecf95bd7d)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_4787408ecf95bd7d},
week.map((day_data,index_ee256d35679abe48)=>(jsx(
Fragment,
{key:index_ee256d35679abe48},
...
export function Main_013f151d01154f0b32d2dc4db2cc1018 () {
...
"Agendar Nueva Cita"
,),jsx(Form_6f0bc1ba8e311ea01189713474c93c04,{},)
,),jsx(
"div",
...
export function Fragment_cfcbadab9e514cfd4bdd52eb2fac788b () {
...
,jsx(Fragment_0c9e09a234db6e3ca3197d4af175980d,{},)
,),)) : (jsx(Fragment,{},)
)),)
  )
}
...
Fragment,
{},
jsx(Main_013f151d01154f0b32d2dc4db2cc1018,{},)
,jsx(
NextHead,
{},
jsx(
