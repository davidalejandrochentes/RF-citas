...
export function Div_ccbe0c974c0002be3ad9744b4b0c19e2 () {
...
reflex___state____state__app___states___state____barber_state.services.map((service,index_04b152d66016dbba)=>(jsx(
"div",
{className:"flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg",key:index_04b152d66016dbba},
jsx(
"p",
...
export function Fragment_fc8e5786c977a5bce524a0bde49d0f32 () {
...
,jsx(Div_6db6d8c4313073b5688fb7bd10c15312,{},)
...
export function Div_578a069a2396cbae09b755287b1b4146 () {
...
reflex___state____state__app___states___state____barber_state.filtered_appointments.map((appointment,index_5047fd94b1f62395)=>(jsx(
"div",
{className:"bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300",key:index_5047fd94b1f62395},
jsx(
"div",
{},
jsx(
...
export function Div_713659982cef674ef59394aeff782b0f () {
...
"div",
{className:"flex flex-col gap-2"},
reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_55ac242781ce1f82)=>(jsx(
"div",
{className:"flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg",key:index_55ac242781ce1f82},
jsx(
"p",
{className:"font-medium"},
barber["name"]
...
export function Div_5aaa7b91a0175e2373a7a2ad24c6d077 () {
...
"div",
{className:"flex flex-col gap-2"},
reflex___state____state__app___states___state____barber_state.calendar_weeks.map((week,index_7a172595ccd15a62)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_7a172595ccd15a62},
week.map((day_data,index_c9a3313e907a5d7c)=>(jsx(
Fragment,
{key:index_c9a3313e907a5d7c},
(isTrue(day_data["is_in_month"]) ? (jsx(
Fragment,
{},
jsx(
"button",
{className:((day_data["date_str"] === reflex___state____state__app___states___state____barber_state.availability_selected_date) ? "p-2 rounded-full bg-blue-600 text-white w-10 h-10 flex items-center justify-center font-bold shadow-lg" : (isTrue(day_data["is_today"]) ? "p-2 rounded-full bg-blue-100 text-blue-600 w-10 h-10 flex items-center justify-center font-semibold" : "p-2 rounded-full hover:bg-gray-100 w-10 h-10 flex items-center justify-center transition-colors")),onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.handle_availability_date_change", ({ ["date_str"] : day_data["date_str"] }), ({  })))], args, ({  })))),type:"button"},
day_data["day"]
,),)) : (jsx(
Fragment,
{},
...
export function Div_6db6d8c4313073b5688fb7bd10c15312 () {
...
reflex___state____state__app___states___state____barber_state.all_possible_times.map((time,index_d9bbe1ae876e4e71)=>(jsx(
"button",
{className:(reflex___state____state__app___states___state____barber_state.availability_selected_times.includes(time) ? "w-full py-2 px-2 rounded-lg bg-blue-600 text-white font-semibold shadow-md" : "w-full py-2 px-2 rounded-lg bg-gray-100 hover:bg-blue-100 text-gray-800 font-medium transition-colors"),key:index_d9bbe1ae876e4e71,onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.toggle_availability_time", ({ ["time"] : time }), ({  })))], args, ({  }))))},
jsx(
Moment,
...
export function Select_9f0aae34942c7ca47a75deecf3a988fe () {
...
{value:""},
"Todos los servicios"
,),reflex___state____state__app___states___state____barber_state.services.map((service,index_26550a330b21b67c)=>(jsx(
"option",
{key:index_26550a330b21b67c,value:service["name"]},
service["name"]
,))),)
  )
}
...
export function Div_aeb39eb30ba47d1851b5f68caa5a380b () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_0d1f9b1a505d29bc)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_0d1f9b1a505d29bc},
day
,))),)
  )
}
...
export function Select_ecba5177fa19b08fd75c8f0d891a87b0 () {
...
reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_767fcab77bb35cba)=>(jsx(
"option",
{key:index_767fcab77bb35cba,value:barber["id"]},
barber["name"]
,))),)
  )
}

export function Fragment_481a0c9fe37d7c1e19ce1dc6440ea608 () {
...
Fragment,
{},
jsx(Div_578a069a2396cbae09b755287b1b4146,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
,jsx(Div_713659982cef674ef59394aeff782b0f,{},)
,),jsx(
"div",
{className:"w-full bg-white p-6 rounded-xl shadow-md border border-gray-100"},
jsx(
...
,jsx("div",{className:"my-6 border-t border-gray-200"},)
,jsx(Div_ccbe0c974c0002be3ad9744b4b0c19e2,{},)
,),),jsx(
"div",
...
"div",
{className:"mb-4"},
jsx(Select_ecba5177fa19b08fd75c8f0d891a87b0,{},)
,),jsx(
"div",
...
,),jsx(Div_aeb39eb30ba47d1851b5f68caa5a380b,{},)
,jsx(Div_5aaa7b91a0175e2373a7a2ad24c6d077,{},)
,),jsx(Fragment_fc8e5786c977a5bce524a0bde49d0f32,{},)
,),),jsx(
"div",
...
,jsx(Select_9f0aae34942c7ca47a75deecf3a988fe,{},)
...
"Pr\u00f3ximas Citas"
,),jsx(Fragment_481a0c9fe37d7c1e19ce1dc6440ea608,{},)
,),),),jsx(
NextHead,
{},
jsx(
