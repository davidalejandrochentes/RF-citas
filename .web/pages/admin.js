...
export function Div_934ae58e086cd85dfc4284501175dba1 () {
...
reflex___state____state__app___states___state____barber_state.filtered_appointments.map((appointment,index_949d70678328ac04)=>(jsx(
"div",
{className:"bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300",key:index_949d70678328ac04},
jsx(
"div",
{},
jsx(
...
export function Select_a44d6e4316794da4374d2a49a515d844 () {
...
{value:""},
"Todos los servicios"
,),reflex___state____state__app___states___state____barber_state.services.map((service,index_101e91367b889a6c)=>(jsx(
"option",
{key:index_101e91367b889a6c,value:service["name"]},
service["name"]
,))),)
  )
}
...
export function Div_5c4be18fcd12d082d002f879d73cfd05 () {
...
reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_f66ad7d1727d8d0c)=>(jsx(
"div",
{className:"flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg",key:index_f66ad7d1727d8d0c},
jsx(
"p",
...
export function Div_5c8631ab208127f017a12fc943557146 () {
...
"div",
{className:"flex flex-col gap-2"},
reflex___state____state__app___states___state____barber_state.services.map((service,index_d2a6bb8600a2ba6f)=>(jsx(
"div",
{className:"flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg",key:index_d2a6bb8600a2ba6f},
jsx(
"p",
{className:"font-medium"},
...
export function Fragment_fb07443661bff10f480dde5f01bea23b () {
...
Fragment,
{},
jsx(Div_934ae58e086cd85dfc4284501175dba1,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
,jsx(Div_5c4be18fcd12d082d002f879d73cfd05,{},)
,),jsx(
"div",
{className:"w-full bg-white p-6 rounded-xl shadow-md border border-gray-100"},
jsx(
...
,jsx("div",{className:"my-6 border-t border-gray-200"},)
,jsx(Div_5c8631ab208127f017a12fc943557146,{},)
,),),jsx(
"div",
...
,jsx(Select_a44d6e4316794da4374d2a49a515d844,{},)
...
"Pr\u00f3ximas Citas"
,),jsx(Fragment_fb07443661bff10f480dde5f01bea23b,{},)
,),),),jsx(
NextHead,
{},
jsx(
