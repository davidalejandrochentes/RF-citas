...
export function Div_70bd82798866fbde32d06179b95be74a () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_908b755d9e47c7e2)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_908b755d9e47c7e2},
day
,))),)
  )
}
...
export function Select_02de93e1bba5c365559285532f91bfcd () {
...
reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_43e3ce332aef0e3e)=>(jsx(
"option",
{key:index_43e3ce332aef0e3e,value:barber["id"]},
barber["name"]
,))),)
  )
}

export function Fragment_0c8ca4bb2c2b41853a1b0bb18b525dc1 () {
...
,jsx(Div_97a8801d06da218b46822599aeed1942,{},)
...
export function Div_97a8801d06da218b46822599aeed1942 () {
...
reflex___state____state__app___states___state____barber_state.all_possible_times.map((time,index_6cd8a275a4e158f2)=>(jsx(
"button",
{className:(reflex___state____state__app___states___state____barber_state.availability_selected_times.includes(time) ? "w-full py-2 px-2 rounded-lg bg-blue-600 text-white font-semibold shadow-md" : "w-full py-2 px-2 rounded-lg bg-gray-100 hover:bg-blue-100 text-gray-800 font-medium transition-colors"),key:index_6cd8a275a4e158f2,onClick:((...args) => (addEvents([(Event("reflex___state____state.app___states___state____barber_state.toggle_availability_time", ({ ["time"] : time }), ({  })))], args, ({  }))))},
jsx(
Moment,
...
export function Select_28e9ae5f279ce8fb14e4baa12db605da () {
...
{value:""},
"Todos los servicios"
,),reflex___state____state__app___states___state____barber_state.services.map((service,index_7ccb9afbf6619bc1)=>(jsx(
"option",
{key:index_7ccb9afbf6619bc1,value:service["name"]},
service["name"]
,))),)
  )
}

export function Fragment_52312366f1accacb00a0c0c426886864 () {
...
Fragment,
{},
jsx(Div_3f0befc8c47a92bab7f310d556007081,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
export function Div_3f0befc8c47a92bab7f310d556007081 () {
...
export function Div_9e6d1b65aecce89703db20d9aa557bfa () {
...
"div",
{className:"flex flex-col gap-2"},
reflex___state____state__app___states___state____barber_state.calendar_weeks.map((week,index_14379ac01e9e1c1b)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_14379ac01e9e1c1b},
week.map((day_data,index_77881e51441c537d)=>(jsx(
Fragment,
{key:index_77881e51441c537d},
...
"div",
{className:"mb-4"},
jsx(Select_02de93e1bba5c365559285532f91bfcd,{},)
,),jsx(
"div",
...
,),jsx(Div_70bd82798866fbde32d06179b95be74a,{},)
,jsx(Div_9e6d1b65aecce89703db20d9aa557bfa,{},)
,),jsx(Fragment_0c8ca4bb2c2b41853a1b0bb18b525dc1,{},)
,),),jsx(
"div",
...
,jsx(Select_28e9ae5f279ce8fb14e4baa12db605da,{},)
...
"Pr\u00f3ximas Citas"
,),jsx(Fragment_52312366f1accacb00a0c0c426886864,{},)
,),),),jsx(
NextHead,
{},
jsx(
