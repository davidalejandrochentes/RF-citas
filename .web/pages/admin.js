...
export function Div_d25c30fc40d66368ea1a91f2c0741c3d () {
...
reflex___state____state__app___states___state____barber_state.filtered_appointments.map((appointment,index_826aa3e932646d1a)=>(jsx(
"div",
{className:"bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300",key:index_826aa3e932646d1a},
jsx(
"div",
{},
jsx(
...
export function Fragment_893c99a23babe5dc9bbb120d815dbc36 () {
...
,jsx(Div_5561bbff02246be76a384016f630e14d,{},)
...
export function Div_666f7964e1c83016d0d8c0c801a05700 () {
...
reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_61d9424c71e2c156)=>(jsx(
"div",
{className:"flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg",key:index_61d9424c71e2c156},
jsx(
"p",
...
export function Select_d38eaad7e0898a526a335e47c5517ffb () {
...
reflex___state____state__app___states___state____barber_state.barbers.map((barber,index_19f657d8be7e618f)=>(jsx(
"option",
{key:index_19f657d8be7e618f,value:barber["id"]},
barber["name"]
,))),)
  )
}

export function Div_5561bbff02246be76a384016f630e14d () {
...
export function Div_2f258fa6bef82b7c5b69bdd9bd2f09f9 () {
...
"div",
{className:"flex flex-col gap-2"},
reflex___state____state__app___states___state____barber_state.services.map((service,index_950631573c8eb784)=>(jsx(
"div",
{className:"flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg",key:index_950631573c8eb784},
jsx(
"p",
{className:"font-medium"},
...
export function Div_5a1de157dd2fa9b7747488b5437f741f () {
...
"div",
{className:"flex flex-col gap-2"},
reflex___state____state__app___states___state____barber_state.admin_calendar_weeks.map((week,index_2e0508458d6d3e21)=>(jsx(
"div",
{className:"grid grid-cols-7 gap-2",key:index_2e0508458d6d3e21},
week.map((day_data,index_ddd6b225c93c68d1)=>(jsx(
Fragment,
{key:index_ddd6b225c93c68d1},
...
export function Fragment_211fbc0285aec44c51e08a8a077f51bb () {
...
Fragment,
{},
jsx(Div_d25c30fc40d66368ea1a91f2c0741c3d,{},)
,)) : (jsx(
Fragment,
{},
jsx(
...
export function Div_6976e1eb4577ed1e7ab2efe474f8024a () {
...
reflex___state____state__app___states___state____barber_state.week_days.map((day,index_b19ce01fb6470699)=>(jsx(
"div",
{className:"text-center font-medium text-sm text-gray-500",key:index_b19ce01fb6470699},
day
,))),)
  )
}
...
export function Select_d28f3ce3773a8a657543087fec90c234 () {
...
{value:""},
"Todos los servicios"
,),reflex___state____state__app___states___state____barber_state.services.map((service,index_297bc1c7fce90dca)=>(jsx(
"option",
{key:index_297bc1c7fce90dca,value:service["name"]},
service["name"]
,))),)
  )
}
...
,jsx(Div_666f7964e1c83016d0d8c0c801a05700,{},)
,),jsx(
"div",
{className:"w-full bg-white p-6 rounded-xl shadow-md border border-gray-100"},
jsx(
...
,jsx("div",{className:"my-6 border-t border-gray-200"},)
,jsx(Div_2f258fa6bef82b7c5b69bdd9bd2f09f9,{},)
,),),jsx(
"div",
...
"div",
{className:"mb-4"},
jsx(Select_d38eaad7e0898a526a335e47c5517ffb,{},)
,),jsx(
"div",
...
,),jsx(Div_6976e1eb4577ed1e7ab2efe474f8024a,{},)
,jsx(Div_5a1de157dd2fa9b7747488b5437f741f,{},)
,),jsx(Fragment_893c99a23babe5dc9bbb120d815dbc36,{},)
,),),jsx(
"div",
...
,jsx(Select_d28f3ce3773a8a657543087fec90c234,{},)
...
"Pr\u00f3ximas Citas"
,),jsx(Fragment_211fbc0285aec44c51e08a8a077f51bb,{},)
,),),),jsx(
NextHead,
{},
jsx(
